            ...
            <div className="max-w-container px-4 md:px-0 mx-auto">
                <div className="bg-[#0B1C77] rounded-xl py-12 md:px-16 px-6">
                    <div className="md:flex justify-between md:gap-x-16 items-center">
                        <div data-aos="fade-up" className="md:w-2/4 py-8">
                            <div className="">
                            ...
                            <div className="">
                            <input className="w-full mt-[30px] py-4 px-6 rounded-xl outline-none font-light font-barlow text-xl text-[#9A9AA0]" id="name" type="text" placeholder="Name"/>
                            <input className="w-full mt-[30px] py-4 px-6 rounded-xl outline-none font-light font-barlow text-xl text-[#9A9AA0]" id="name" type="text" placeholder="Email"/>
                            <textarea className="w-full mt-[30px] h-36 py-4 px-6 rounded-xl outline-none font-light font-barlow text-xl text-[#9A9AA0]" id="message" placeholder="Message"></textarea>
                            <div className="mt-12 font-semibold text-white font-barlow text-xl cursor-pointer hover:text-[#000] hover:bg-white py-4 rounded-[5px] hover:shadow-btnshadow shadow-btnbtnshadow md:px-36 bg-primary duration-300  text-center">
                                    <a className='' href="#">Submit Message</a>
                                </div>
                            </div>
                        </div>
                        <div data-aos="fade-down" className="md:w-2/4">
