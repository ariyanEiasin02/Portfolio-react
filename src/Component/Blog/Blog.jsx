                ...
                <div className="max-w-container px-4 md:px-0 mx-auto">
                    ...
                    <div className="mt-10">
                        <div className="md:flex justify-between">
                            <div data-aos="fade-right" className="md:w-[32%] cursor-pointer">
                                ...
                                <h3 className="font-semibold font-barlow text-[18px]  text-[#000000] hover:text-[#FC7868]">Jim Morisson Says when the musics over turn off the light</h3>
                                </div>
                            </div>
                            <div data-aos="fade-up" className="md:w-[32%]  mt-6 md:mt-0 cursor-pointer">
                                <div className="overflow-hidden rounded-lg">
                            ...
                            <div data-aos="fade-left" className="md:w-[32%] mt-6 md:mt-0 cursor-pointer">
                                <div className="overflow-hidden rounded-lg">
