            ...
            <section id='Service' className="py-12">
               ...
               <SimpleBarReact style={{ maxHeight: 800 }}>
                        ...
                        <div class="descriptions">
                            <h3 className="mt-6 font-semibold font-barlow md:text-4xl text-2xl text-[#000]">Desktop Application</h3>
